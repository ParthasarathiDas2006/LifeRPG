...
export const HERO_PRESETS: HeroPreset[] = [
  ...
  // 1. ORIGINAL FEMALE BATTLE ROYALE HERO - SOLARIS (REPLACES KELLY)
  {
    ...
    ability: {
      name: 'Solar Flare Acceleration',
      description: 'Overcharges titanium micro-conduits, increasing sprint velocity and habit streak XP by +25%.',
      icon: '☀️',
      buffText: '+25% Solar Velocity & Habit Multiplier',
    },
    battleStats: { winRate: 90, kdRatio: 5.3, agility: 99, combatPower: 3450 },
    portraitUrl: HERO_GAME_ART['hero-original-solaris'],
    humanSpecs: {
      ...
      armsAndGloves: 'Toned athletic arms with carbon-composite forearm guards and tactile shooting gloves',
      legsAndBoots: 'High-mobility tactical exosuit legs with dual side mag-locks and reinforced magnetic combat boots',
    },
    description: 'Completely original 3D battle-royale champion. An orbital drop zone specialist equipped with a solar-powered titanium exosuit, dual cooling thruster pack, and all-terrain combat boots.',
    parts: {
      gender: 'FEMALE',
      body: 'fair',
      hair: 'kelly_freefire',
  ...
  // 2. ORIGINAL MALE BATTLE ROYALE HERO - COMMANDER AEGIS (REPLACES PUBG LONE SURVIVOR)
  {
    ...
    ability: {
      name: 'Aegis Ballistic Bulwark',
      description: 'Heavy composite ballistic plates grant +30% willpower and create an impenetrable distraction shield.',
      icon: '🛡️',
      buffText: '+30% Willpower & Damage Resistance',
    },
    battleStats: { winRate: 92, kdRatio: 5.7, agility: 93, combatPower: 3550 },
    portraitUrl: HERO_GAME_ART['hero-original-aegis'],
    humanSpecs: {
      ...
      armsAndGloves: 'Broad muscular arms, tactical leather-reinforced shooting gloves',
      legsAndBoots: 'Heavy-duty tactical cargo trousers with reinforced knee armor and all-weather combat assault boots',
    },
    description: 'Completely original 3D battle-royale commander. Master of highland extraction, equipped with modular tungsten-composite plate armor and a heavy military assault ruck.',
    parts: {
      gender: 'MALE',
      body: 'fair',
      hair: 'pubg_spetsnaz',
